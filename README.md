...
### [Live DEMO](https://Docs-API.catteam123.repl.co))
...
//Tạo API KEY FREE
var name = 'D-Jukie';
axios.get(`https://Docs-API.catteam123.repl.co/apikey?type=register&name=${name}`)
...
//Tạo API KEY PREMIUM
var name = 'D-Jukie';
axios.get(`https://Docs-API.catteam123.repl.co/apikey?type=register&name=${name}&apikey=JRTxTracy_VIP`)
    .then(function (response) {
        console.log(response.apikey)
    })
    .catch(function (error) {
...
axios.get(`https://Docs-API.catteam123.repl.co/apikey?type=checker&apikey=${apikey}`)
    .then(function (response) {
...
var delay = 500
axios.get(`https://Docs-API.catteam123.repl.co/blink?id=${idFacebook}&delay=${delay}`)
    .then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
var name = 'Nguyễn Hải Đăng',
    ...
    uid = '100033478361032'
axios.get(`https://Docs-API.catteam123.repl.co/fbcover/v1?name=${name}&color=${color}&address=${address}&email=${email}&subname=${subname}&sdt=${numberphone}&uid=${uid}`)
    .then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
var name = 'Nguyễn Hải Đăng',
    ...
    subname = 'J-JRT',
    uid = '100033478361032'
axios.get(`https://Docs-API.catteam123.repl.co/fbcover/v2?name=${name}&color=${color}&subname=${subname}&uid=${uid}`)
    .then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
var uid = '100033478361032',
    ...
    follow = '37086',
    gender = 'Nam'
axios.get(`https://Docs-API.catteam123.repl.co/fbcover/v3?name=${name}&birthday=${birthday}&love=${love}&location=${location}&hometown=${hometown}&follow=${follow}&gender=${gender}&uid=${uid}`)
    .then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
`
axios.post('https://Docs-API.catteam123.repl.co/upcode', {code: code}).
    then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
{
  "status": true,
  "url": "https://Docs-API.catteam123.repl.co/upcode/raw/?id=6GF1SYTOMG"
}
```
Error 
```json
...
axios.get('https://Docs-API.catteam123.repl.co/tiktok?search=' + keyword).
    then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
axios.get('https://Docs-API.catteam123.repl.co/tiktok?username=' + username).
    then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
...
axios.get('https://Docs-API.catteam123.repl.co/tiktok?url=' + url).
    then(function (response) {
        console.log(response)
    })
    .catch(function (error) {
